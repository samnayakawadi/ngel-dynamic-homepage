    ...
    const InstructorCourseData = async () => {
        try {
            ...
            State({
                ...
                cke_3: '',
                courseIcon: '',
                courseIconUrl: `http://10.244.3.218:8082/${res.data.imageUrl}`,
                courseBanner: '',
                courseBannerUrl: `http://10.244.3.218:8082/${res.data.banner}`,
                courseVideo: '',
                courseVideoUrl: `http://10.244.3.218:8082/${res.data.video}`,
