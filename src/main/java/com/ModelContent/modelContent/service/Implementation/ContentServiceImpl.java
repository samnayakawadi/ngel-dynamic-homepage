...
public class ContentServiceImpl implements ContentService {
	...
	public GlobalReponse updateContentModel(ContentModelDTO contentModelDTO, String language)
		...
		System.out.println(
				"contentModelDTO.getCall_us_phone().getLink() : " + contentModelDTO.getCall_us_phone().getLink().getValue());
		...
		existingContent.getCall_us_phone().getTitle().setValue(contentModelDTO.getCall_us_phone().getTitle().getValue());
		...
		existingContent.getEnquiry_us_id().getTitle().setValue(contentModelDTO.getEnquiry_us_id().getTitle().getValue());
	    ...
	    existingContent.getFooterPoweredBy().getTitle().setValue(contentModelDTO.getFooterPoweredBy().getTitle().getValue());
		existingContent.getFooterPoweredBy().getLink().setValue(contentModelDTO.getFooterPoweredBy().getLink().getValue());
